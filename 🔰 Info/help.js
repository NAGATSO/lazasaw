  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_dc = new MessageButton().setStyle('url').setLabel('Support').setURL("https://discord.gg/ZZ3SueTWmZ").setEmoji("✉️")
        let button_invite = new MessageButton().setStyle('url').setLabel('Youtube').setURL("https://www.youtube.com/channel/UCqFnmaK6zK4KuIztPDxrO8A/videos").setEmoji("865965667370795028")
...
📶 **\`${Math.floor(client.ws.ping)}ms\` Ping**`)        
        ...
        let d_button_dc = new MessageButton().setStyle('url').setLabel('<:Youtube:840260133686870036>').setURL("https://discord.gg/ZZ3SueTWmZ");
